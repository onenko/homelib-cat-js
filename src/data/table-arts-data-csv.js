...
Genre - Literature Work genre or several genres
...
const ARTS_data_csv = [
"Кідрук:Бот:a`Бот`2008`uk`N`sfa/sfn``Кідрук:Бот:cy`1",
"Кідрук:Бот2:a`Бот:Гуаякільський синдром`2015`uk`N`sfa/sfn``Кідрук:Бот:cy`2",
"Coelho:O~Alquimista:a`O Alquimista`1988`pt`N`phi```",
"Bushnell:Summer~and~the~City:a`Summer and the City`2011`en`N`rom```",
"Ilf:Petrov:Zolotoy~telenok:a`Золотой теленок`1931`ru`N`cla/cri```",
"Дюма:ГрафМонтеКристо:a`Граф Монте-Кристо`1977`ru`T`cla/adv```"
];
